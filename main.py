#to do goalkeeper wali dikkat solve kr dekh dono goalkeeper ko same green ellipse aarha h 
import numpy as np
...
def main():
    video_frames=read_video("input_videos/video_2024-11-15_15-30-08.mp4")
